...
class Paccofacile {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Paccofacile_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'PACCOFACILE_VERSION' ) ) {
			$this->version = PACCOFACILE_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	...
	public function register_courier_post_type() {
		$labels = array(
			...
			'singular_name'         => _x( 'Carrier', 'Post type singular name', 'paccofacile' ),
			'menu_name'             => _x( 'Carriers', 'Admin Menu text', 'paccofacile' ),
			'name_admin_bar'        => _x( 'Carrier', 'Add New on Toolbar', 'paccofacile' ),
			'add_new'               => __( 'Add New', 'paccofacile' ),
			'add_new_item'          => __( 'Add New Carrier', 'paccofacile' ),
			'new_item'              => __( 'New Carrier', 'paccofacile' ),
			'edit_item'             => __( 'Edit Carrier', 'paccofacile' ),
			'view_item'             => __( 'View Carrier', 'paccofacile' ),
			'all_items'             => __( 'All Carriers', 'paccofacile' ),
			'search_items'          => __( 'Search Carriers', 'paccofacile' ),
			'parent_item_colon'     => __( 'Parent Carrier:', 'paccofacile' ),
			'not_found'             => __( 'No Carriers found.', 'paccofacile' ),
			'not_found_in_trash'    => __( 'No Carriers found in Trash.', 'paccofacile' ),
			'featured_image'        => _x( 'Carrier Cover Image', 'Overrides the “Featured Image” phrase for this post type. Added in 4.3', 'paccofacile' ),
			'set_featured_image'    => _x( 'Set cover image', 'Overrides the “Set featured image” phrase for this post type. Added in 4.3', 'paccofacile' ),
			'remove_featured_image' => _x( 'Remove cover image', 'Overrides the “Remove featured image” phrase for this post type. Added in 4.3', 'paccofacile' ),
			'use_featured_image'    => _x( 'Use as cover image', 'Overrides the “Use as featured image” phrase for this post type. Added in 4.3', 'paccofacile' ),
			'archives'              => _x( 'Carrier archives', 'The post type archive label used in nav menus. Default “Post Archives”. Added in 4.4', 'paccofacile' ),
			'insert_into_item'      => _x( 'Insert into Carrier', 'Overrides the “Insert into post”/”Insert into page” phrase (used when inserting media into a post). Added in 4.4', 'paccofacile' ),
			'uploaded_to_this_item' => _x( 'Uploaded to this Carrier', 'Overrides the “Uploaded to this post”/”Uploaded to this page” phrase (used when viewing media attached to a post). Added in 4.4', 'paccofacile' ),
			'filter_items_list'     => _x( 'Filter Carriers list', 'Screen reader text for the filter links heading on the post type listing screen. Default “Filter posts list”/”Filter pages list”. Added in 4.4', 'paccofacile' ),
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'admin_init', $plugin_admin, 'paccofacile_register_settings' );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Paccofacile_Loader    Orchestrates the hooks of the plugin.
	 */
